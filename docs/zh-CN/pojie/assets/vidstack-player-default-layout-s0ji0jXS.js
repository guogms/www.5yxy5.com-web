const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-BTigPj2h-j5VmU2rh.js","assets/app-CMItl1_6.js"])))=>i.map(i=>d[i]);
var vs=Object.defineProperty;var fs=Object.getPrototypeOf;var hs=Reflect.get;var pe=e=>{throw TypeError(e)};var $s=(e,t,s)=>t in e?vs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var _=(e,t,s)=>$s(e,typeof t!="symbol"?t+"":t,s),Gt=(e,t,s)=>t.has(e)||pe("Cannot "+s);var v=(e,t,s)=>(Gt(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?pe("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),D=(e,t,s,n)=>(Gt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),h=(e,t,s)=>(Gt(e,t,"access private method"),s);var Lt=(e,t,s)=>hs(fs(e),s,t);import{aO as x,h as be,j as P,o as at,aN as ge,bU as bs,ap as C,g as R,aL as gs,an as ys,aI as xs,w,bV as ye,C as Ss,bW as xe,bX as g,aH as Ts,q as Yt,b9 as Se,ar as st,bY as Te,ax as ws,bZ as ks,A as Cs,aK as we,b_ as bt,k as ot,b$ as As,s as Ds,af as Ms,c0 as Is,aB as Os,z as V,c1 as _s,aS as Ps,_ as Gs,as as ke,l as Nt,aW as Ls,c2 as Ns,c3 as Bs,c4 as Fs,bk as Ce}from"./app-CMItl1_6.js";import{A as W,T as Vs,D as me,x as l,s as Rs,L as Ae}from"./vidstack-CwTj4H1w-BCQqYYxA.js";/**
 * @license
 ...
 */const nt=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const o of i)(n=(s=o)._$AO)===null||n===void 0||n.call(s,t,!1),nt(o,t);return!0},yt=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},De=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),zs(t)}};function Qs(e){this._$AN!==void 0?(yt(this),this._$AM=e,De(this)):this._$AM=e}function Us(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let o=s;o<n.length;o++)nt(n[o],!1),yt(n[o]);else n!=null&&(nt(n,!1),yt(n));else nt(this,e)}const zs=e=>{var t,s,n,i;e.type==gt.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Us),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Qs))};class Me extends Xt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),De(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(nt(this,t),yt(this))}setValue(t){if(Es(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}var G,lt,Q,O,Et,Kt,Ie,Oe;class qs extends Me{constructor(s){super(s);b(this,O);b(this,G,null);b(this,lt,!1);b(this,Q,null);D(this,lt,s.type===gt.ATTRIBUTE||s.type===gt.BOOLEAN_ATTRIBUTE)}render(s){return s!==v(this,G)&&(this.disconnected(),D(this,G,s),this.isConnected&&h(this,O,Et).call(this)),v(this,G)?h(this,O,Kt).call(this,be(v(this,G))):W}reconnected(){h(this,O,Et).call(this)}disconnected(){var s;(s=v(this,Q))==null||s.call(this),D(this,Q,null)}}G=new WeakMap,lt=new WeakMap,Q=new WeakMap,O=new WeakSet,Et=function(){v(this,G)&&D(this,Q,P(h(this,O,Oe).bind(this)))},Kt=function(s){return v(this,lt)?Zt(s):s},Ie=function(s){this.setValue(h(this,O,Kt).call(this,s))},Oe=function(){var s;h(this,O,Ie).call(this,(s=v(this,G))==null?void 0:s.call(this))};function a(e){return wt(qs)(x(e))}var U,rt,St,ut,Ht;class _e{constructor(t,s){b(this,ut);b(this,U);b(this,rt);_(this,"elements",new Set);b(this,St,ge(h(this,ut,Ht).bind(this)));D(this,U,t),D(this,rt,s)}connect(){h(this,ut,Ht).call(this);const t=new MutationObserver(v(this,St));for(const s of v(this,U))t.observe(s,{childList:!0,subtree:!0});at(()=>t.disconnect()),at(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){bs(t)?(s.textContent="",s.append(t)):(me(null,s),me(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}}U=new WeakMap,rt=new WeakMap,St=new WeakMap,ut=new WeakSet,Ht=function(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=v(this,U).flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&v(this,rt).call(this,this.elements)};let js=0,ht="data-slot-id";var z,Tt,q,$t;class Pe{constructor(t){b(this,q);b(this,z);_(this,"slots");b(this,Tt,ge(h(this,q,$t).bind(this)));D(this,z,t),this.slots=new _e(t,h(this,q,$t).bind(this))}connect(){this.slots.connect(),h(this,q,$t).call(this);const t=new MutationObserver(v(this,Tt));for(const s of v(this,z))t.observe(s,{childList:!0});at(()=>t.disconnect())}}z=new WeakMap,Tt=new WeakMap,q=new WeakSet,$t=function(){for(const t of v(this,z))for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(ht);i||s.setAttribute(ht,i=++js+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==n||o.getAttribute(ht)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,o),o.setAttribute(ht,i)}}};function Ys({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return l`<svg
  ...
  `}function Ot({label:e,checked:t,defaultChecked:s=!1,storageKey:n,onChange:i}){const{translations:o}=u(),r=n?localStorage.getItem(n):null,p=w(!!(r??s)),c=w(!1),y=a(Os(p)),f=d(o,e);n&&i(be(p)),t&&P(()=>void p.set(t()));function m(T){(T==null?void 0:T.button)!==1&&(p.set(tt=>!tt),n&&localStorage.setItem(n,p()?"1":""),i(p(),T),c.set(!1))}function $(T){_s(T)&&m()}function S(T){T.button===0&&c.set(!0)}return l`
    <div
  ...
  `}function He(){const{audioGains:e}=u(),t=e();return V(t)?t[0]??0:t.min}function Qe(){const{audioGains:e}=u(),t=e();return V(t)?t[t.length-1]??300:t.max}function Gn(){const{audioGains:e}=u(),t=e();return V(t)?t[1]-t[0]||25:t.step}function Ln(){return a(()=>{const{translations:e}=u(),{hasCaptions:t}=g(),s=d(e,"Off");return t()?l`
  ...
  `}function Un(){return a(()=>{const{live:e,duration:t}=g();return e()?Re():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function je(){return a(()=>{const{live:e}=g();return e()?Re():Qn()})}function Ye(){return a(()=>{const{textTracks:e}=C(),{title:t,started:s}=g(),n=w(null);return we(e,"chapters",n.set),n()&&(s()||!t())?Ze():l`<media-title class="vds-chapter-title"></media-title>`})}function Ze(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class Xe extends Xs{async loadIcons(){const t=(await Gs(async()=>{const{icons:n}=await import("./vidstack-BTigPj2h-j5VmU2rh.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Ys({name:n,paths:t[n]});return s}}var F;let zn=(F=class extends Ct{},_(F,"props",{...Lt(F,F,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}),F);function qn(){return[Jt(),ne(),l`
    ...
    `]}function jn(){return a(()=>{let e=w(void 0),t=w(!1),s=C(),{title:n,started:i,currentTime:o,ended:r}=g(),{translations:p}=u(),c=Ns(e),y=()=>i()||o()>0;const f=()=>{const S=r()?"Replay":y()?"Continue":"Play";return`${k(p,S)}: ${n()}`};P(()=>{var S;c()&&document.activeElement===document.body&&((S=s.player.el)==null||S.focus({preventScroll:!0}))});function m(){const S=e(),T=!!S&&!c()&&S.clientWidth<S.children[0].clientWidth;S&&Bs(S,"vds-marquee",T),t.set(T)}function $(){return l`
